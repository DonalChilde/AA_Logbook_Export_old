...
Source: setup_about_template.py
...
# Top level package that contains __about__.py
TOP_PACKAGE_NAME = "src/aaLogbook"

here = path.abspath(path.dirname(__file__))
about: dict = {}
try:
    with open(path.join(here, TOP_PACKAGE_NAME, "__about__.py")) as f:
        exec(f.read(), about)
except FileNotFoundError as e:
    print("Unable to find __about__.py")
    raise e


# Package meta-data.
PYPI_NAME = about["__PYPI_NAME__"]
SHORT_DESCRIPTION = about["__SHORT_DESCRIPTION__"]
URL = about["__URL__"]
...
INSTALL_REQUIRES: list = about["__INSTALL_REQUIRES__"]
# What packages are optional?
EXTRAS_REQUIRE: dict = about["__EXTRAS_REQUIRE__"]
