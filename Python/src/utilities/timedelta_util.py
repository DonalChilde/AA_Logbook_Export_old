...
def timedelta_split(timeDelta:timedelta)-> TimeDeltaSplit:
    ...
    return TimeDeltaSplit(days = days,hours = hours,minutes = minutes,seconds = seconds, microseconds = microseconds)
...
def timedelta_To_isoformat(timeDelta: timedelta, strict=True)->str:
    ...
    if not (timeSplit.hours or timeSplit.minutes or timeSplit.seconds or timeSplit.microseconds):
